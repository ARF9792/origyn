...
export function SourcesPage() {
  ...
  const updateQuery = (
    ...
    router.replace(
      `/workspace/sources?${params.toString()}`
    );
  };
    ...
    <>
      <div className="page-heading">
        <div>
          ...
          <p>
            {allDocs.length} sources available to your
            workspace.
          </p>
        </div>
      ...
      <p className="mobile-table-hint">
        Swipe table horizontally to view full
        details.
      </p>
      ...
      <div className="library-footnote">
        ...
        <p>
          "No retraction found" means Origyn did not
          find a known retraction in scholarly metadata
          registries (e.g. Crossref) for the identified
          DOI. This does not guarantee scientific
          validity or soundness. You are responsible for
          reviewing sources.
        </p>
      </div>
    </>
